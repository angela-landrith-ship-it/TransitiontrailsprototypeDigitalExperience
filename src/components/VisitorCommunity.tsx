  ...
  return (
    <div className="min-h-screen bg-[#F5F3E8]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl text-gray-900 mb-2">Community</h1>
          <p className="text-gray-600">Connect with learners in public Slack channels</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl text-gray-900">Public Slack Channels</h2>
                <Badge className="bg-green-500 text-white">Full Access</Badge>
              </div>
              <div className="space-y-4">
                {publicChannels.map((channel) => (
                  <div key={channel.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 rounded-lg bg-[#2C6975]/10 flex items-center justify-center">
                    ...
                    <div className="space-y-3 mb-4">
                      {channel.messages.map((msg, idx) => (
                        <div key={idx} className="flex items-start space-x-2 p-2 rounded-lg bg-gray-50">
                    ...
                    <div className="flex gap-2">
                      <button className="flex-1 py-2 bg-[#2C6975] text-white rounded-lg hover:bg-[#234d56] transition-colors text-sm flex items-center justify-center space-x-2">
            ...
            {/* Slack Invite CTA */}
            <div className="bg-gradient-to-r from-[#F9A03F]/10 to-[#F9A03F]/5 border-2 border-[#F9A03F]/30 rounded-xl p-6">
              <div className="flex items-start space-x-4">
                <MessageSquare className="w-10 h-10 text-[#F9A03F] flex-shrink-0" />
                <div className="flex-1">
                  <h3 className="text-gray-900 mb-2">Join our Visitor Slack</h3>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl text-gray-900">Premium Channels</h2>
                <Badge className="bg-[#F9A03F] text-white">Unlock with Enrollment</Badge>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                {lockedChannels.map((channel) => (
                  <div key={channel.name} className="bg-white rounded-xl shadow-sm border-2 border-gray-300 p-4 opacity-60 relative">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#7EB5C1]/10 to-[#7EB5C1]/5 border-2 border-[#7EB5C1]/30 rounded-xl p-6">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#7EB5C1] to-[#2C6975] flex items-center justify-center mb-4 ring-4 ring-[#7EB5C1]/20">
                <Sparkles className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-gray-900 mb-2">Ask Penny</h3>
              <p className="text-sm text-gray-700 mb-4 italic">
                "Ask me how to connect with other visitors."
              </p>
              <div className="space-y-2">
                <div className="p-3 bg-white rounded-lg border border-gray-200">
                  <p className="text-xs text-gray-600 mb-1">📚 Top learner story this week:</p>
                  <p className="text-sm text-gray-900">"Sarah completed her Salesforce Admin cert!"</p>
                </div>
                <div className="p-3 bg-white rounded-lg border border-gray-200">
                  <p className="text-xs text-gray-600 mb-1">🎯 Upcoming opportunity:</p>
                  <p className="text-sm text-gray-900">Nonprofit tech jobs available in your area</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-gray-900">Upcoming Public Events</h3>
              </div>
                ...
                {upcomingPublicEvents.map((event) => (
                  <div key={event.id} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <button className="px-3 py-1 bg-[#2C6975] text-white rounded text-xs hover:bg-[#234d56] transition-colors">
                        RSVP
                      </button>
                    </div>
                  </div>
